...
export default function Edit() {
  ...
  const [data, setData] = useState({
    ...
    imgUrl: state.imgUrl,
    preview_img1: state.preview_img1,
    preview_img2: state.preview_img2,
    preview_img3: state.preview_img3
  })

  const handleSubmit = async (e) => {
    e.preventDefault()
    await fetch(`https://6326e609ba4a9c47532c9c95.mockapi.io/${data.category}/${state.id}`, {
      method: "PUT",
