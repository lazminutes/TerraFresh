      ...
      <div className='fitur '>
        ...
        <div className='fitur-all'>
          ...
          <div className='fitur-1 col-md-3 text-center background-white0'>
            <i className="a-solid fa-truck-fast icon animate__animated animate__bounce animate__delay-0s"></i>
            <br />
            <br />
          ...
          <div className='fitur-1 col-md-3 text-center background-white'>
            <i className="a-solid fa-hand-holding-dollar icon animate__animated animate__bounce animate__delay-0s"></i>
            <br />
            <br />
          ...
          <div className='fitur-1 col-md-3 text-center background-white1'>
            <i className="a-solid fa-seedling icon animate__animated animate__bounce animate__delay-0s" ></i>
            <br />
            <br />
